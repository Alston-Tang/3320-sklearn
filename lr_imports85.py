...
train_x_scaled = x_scaler.fit_transform(train_x.astype(float))
test_x_scaled = x_scaler.transform(test_x.astype(float))
train_y_scaled = x_scaler.fit_transform(train_y.astype(float))
test_y_scaled = x_scaler.transform(test_y.astype(float))
